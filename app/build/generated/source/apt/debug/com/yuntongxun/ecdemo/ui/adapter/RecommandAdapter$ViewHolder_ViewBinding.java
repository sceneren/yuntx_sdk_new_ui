...
public class RecommandAdapter$ViewHolder_ViewBinding<T extends RecommandAdapter.ViewHolder> implements Unbinder {
  protected T target;

  @UiThread
  public RecommandAdapter$ViewHolder_ViewBinding(T target, View source) {
    this.target = target;
