...
public abstract class AbstractSQLManager {
    ...
    static class DatabaseHelper extends SQLiteOpenHelper {
        ...
        static final String TABLES_NAME_SYSTEM_NOTICE_FRIEND = "friend_system_notice";
        static final String TABLES_NAME_FRIENDS = "friends";
        ...
        public SQLiteDatabase getReadableDatabase() {
            if (!mainTmpDirSet) {
                boolean rs = new File("/data/data/com.yuntongxun.eckuailiao/databases/main").mkdir();
                super.getReadableDatabase().execSQL("PRAGMA temp_store_directory = '/data/data/ccom.yuntongxun.eckuailiao/databases/main'");
                mainTmpDirSet = true;
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            ...
            if (oldVersion < 19) {
                createFriendTableSystemNotice(db);
                createFriendTable(db);
            }

            if (oldVersion < 20) {//新增聊天背景
                onUpdateSessionTableAddChatingBG(db);
            }
        }

        private void onUpdateSessionTableAddChatingBG(SQLiteDatabase db) {
            String sqlAddchatbg = "ALTER TABLE im_thread ADD  COLUMN chatbg TEXT ";

            String sqlAddIsNotice = "ALTER TABLE im_thread ADD  COLUMN isnotice TEXT";

            db.execSQL(sqlAddchatbg);
            db.execSQL(sqlAddIsNotice);
        }
        ...
        void createTableForISession(SQLiteDatabase db) {
            ...
            String sql = "CREATE TABLE IF NOT EXISTS "
                    ...
                    + IThreadColumn.CHAT_BG + " TEXT ,"
                    + IThreadColumn.IS_NOTICE + " TEXT "
                    + ")";
            LogUtil.v(TAG + ":" + sql);
            db.execSQL(sql);
        }
        ...
        void createFriendTableSystemNotice(SQLiteDatabase db) {
            String sql = "CREATE TABLE IF NOT EXISTS "
                    + TABLES_NAME_SYSTEM_NOTICE_FRIEND + " (" + SystemNoticeColumn.ID
                    + " INTEGER PRIMARY KEY AUTOINCREMENT, "
                    + SystemNoticeColumnFriend.NOTICE_NICKNAME_SEND + " TEXT, "
                    + SystemNoticeColumnFriend.NOTICE_DATECREATED + " TEXT, "
                    + SystemNoticeColumnFriend.NOTICE_RECE + " TEXT, "
                    + SystemNoticeColumnFriend.NOTICE_MSG + " TEXT, "
                    + SystemNoticeColumnFriend.NOTICE_SUBTYPE + " TEXT, "
                    + SystemNoticeColumnFriend.NOTICE_SEND + " TEXT " + ")";
            LogUtil.v(TAG + ":" + sql);
            db.execSQL(sql);
        }

        void createFriendTable(SQLiteDatabase db) {
            String sql = "CREATE TABLE IF NOT EXISTS "
                    + TABLES_NAME_FRIENDS + " (" + SystemNoticeColumn.ID
                    + " INTEGER PRIMARY KEY AUTOINCREMENT, "
                    + FriendColumn.Friend_ID + " TEXT, "
                    + FriendColumn.Friend_Nick + " TEXT, "
                    + FriendColumn.Friend_Pic + " TEXT, "
                    + FriendColumn.Friend_remark + " TEXT, "
                    + FriendColumn.Friend_ship + " TEXT " + ")";
            LogUtil.v(TAG + ":" + sql);
            db.execSQL(sql);
        }
    ...
    public class IThreadColumn extends BaseColumn {
        ...
        //        // 最后一条消息发送者
//        public static final String CONTACT_NANME = "contact_nanme";
        // 文本
    ...
    class SystemNoticeColumnFriend extends BaseColumn {
        // 对应话数据库I的
        // 消息时间
        public static final String NOTICE_DATECREATED = "dateCreated";
        public static final String NOTICE_NICKNAME_SEND = "send_nickname";
        public static final String NOTICE_RECE = "receiver";
        public static final String NOTICE_MSG = "msg";
        public static final String NOTICE_SUBTYPE = "subtype";
        public static final String NOTICE_SEND = "sender";
    }

    class FriendColumn extends BaseColumn {
        // 对应话数据库I的
        // 消息时间
        public static final String Friend_ID = "friend_id";
        public static final String Friend_remark = "remark";
        public static final String Friend_PhoneNum = "phonenum";
        public static final String Friend_Nick = "nickname";
        public static final String Friend_Pic = "photo_url";
        public static final String Friend_ship = "ship";//1 是   0 nox
    }
