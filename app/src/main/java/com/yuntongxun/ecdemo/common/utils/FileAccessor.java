...
public class FileAccessor {
    ...
    public static final String APPS_ROOT_DIR = getExternalStorePath() + "/ECSDK_Demo2";
    public static final String EXPORT_DIR = getExternalStorePath() + "/ECSDK_Demo2/ECDemo_IM";
    public static final String CAMERA_PATH = getExternalStorePath() + "/DCIM/ECSDK_Demo2";
    public static final String TACK_PIC_PATH = getExternalStorePath()+ "/ECSDK_Demo2/.tempchat";
    public static final String IMESSAGE_VOICE = getExternalStorePath() + "/ECSDK_Demo2/voice";
    public static final String IMESSAGE_IMAGE = getExternalStorePath() + "/ECSDK_Demo2/image";
    public static final String IMESSAGE_AVATAR = getExternalStorePath() + "/ECSDK_Demo2/avatar";
    public static final String IMESSAGE_FILE = getExternalStorePath() + "/ECSDK_Demo2/file";
    public static final String IMESSAGE_RICH_TEXT = getExternalStorePath() + "/ECSDK_Demo2/richtext";
