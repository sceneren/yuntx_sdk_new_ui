...
public class VoiceMeetingMemberManager extends MeetingBaseActivity {
    ...
    public void onMeetingMembers(List<? extends ECMeetingMember> members) {
        ...
        Iterator<? extends ECMeetingMember> iterator = members.iterator();
        ECMeetingMember loginMember = null;

        while (iterator.hasNext()) {
            ECMeetingMember next = iterator.next();
            if (next == null) {
                continue;
            }
            if (CCPAppManager.getUserId().equals(next.getNumber()) && isSelfMeeting) {//
                loginMember = next;
                iterator.remove();
            }
        }
    ...
    public class MeetingMemberAdapter extends ArrayAdapter<ECVoiceMeetingMember> {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            if (item != null) {
                ...
                mViewHolder.chatroom_contact_del_btn.setText(R.string.chatroom_permission_remove);
