...
import static com.yuntongxun.ecdemo.R.string.age;
...
public class MultiVideoMember extends ECVideoMeetingMember  {
	...
	public boolean equals(Object obj) {
		...
		if(obj instanceof MultiVideoMember){
			MultiVideoMember member = (MultiVideoMember)obj;
			if(member.getNumber().equals(this.getNumber())){
				return true;
			}else{
				return false;
			}
