...
public class InterPhoneHelper {
     ...
     * 发起实时对讲
     */
    public static void startInterphone(ArrayList<ECContacts> ecContactsArrayList) {
        ...
        String [] members  = new String[ecContactsArrayList.size()];
        for (int i = 0; i < ecContactsArrayList.size(); i++) {
            ECContacts contacts = ecContactsArrayList.get(i);
            members[i] = contacts.getContactid();
        }
