 ...
 */
public class InterPhoneMicController extends LinearLayout implements View.OnTouchListener {
            ...
            switch (msg.what) {
                case WHAT_ON_REQUEST_MIC_CONTROL:
                    if(isDownEvent && mOnInterPhoneMicListener != null) {
                        mTvNotice.setVisibility(INVISIBLE);
    ...
    public void setControlMicType(MicType type) {
        ...
        if(type == MicType.CONTROL) {
            ...
            mChronometer.start();
            mInterSpeak.setBackgroundResource(R.drawable.chat_yuyin_icon_duijiang_high) ;
            return ;
        }
        ...
        if(isDownEvent) {
            ...
            mInterSpeak.setBackgroundResource(R.drawable.chat_yuyin_icon_duijiang_normal) ;
        }
    }
