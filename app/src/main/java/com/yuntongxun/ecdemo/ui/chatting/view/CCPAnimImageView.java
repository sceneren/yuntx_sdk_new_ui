...
public class CCPAnimImageView extends TextView {
	...
	public void initCCPAnimImageView() {
		...
		Drawable chattingFDrawale1 = getResources().getDrawable(R.drawable.fanyuyin0);
		chattingFDrawale1.setBounds(15, 0, chattingFDrawale1.getIntrinsicWidth(), chattingFDrawale1.getIntrinsicHeight());
		mChattingFromAnimationDrawable.addFrame(chattingFDrawale1, mDuration);
		
		Drawable chattingFDrawale2 = getResources().getDrawable(R.drawable.fanyuyin1);
		chattingFDrawale2.setBounds(15, 0, chattingFDrawale2.getIntrinsicWidth(), chattingFDrawale2.getIntrinsicHeight());
		mChattingFromAnimationDrawable.addFrame(chattingFDrawale2, mDuration);
		
		Drawable chattingFDrawale3 = getResources().getDrawable(R.drawable.fanyuyin2);
		chattingFDrawale3.setBounds(15, 0, chattingFDrawale3.getIntrinsicWidth(), chattingFDrawale3.getIntrinsicHeight());
		...
		Drawable chattingTDrawable_1 = getResources().getDrawable(R.drawable.yuyin0);
		chattingTDrawable_1.setBounds(15, 0, chattingTDrawable_1.getIntrinsicWidth(), chattingTDrawable_1.getIntrinsicHeight());
		mChattingToAnimationDrawable.addFrame(chattingTDrawable_1, mDuration);
		
		Drawable chattingTDrawable_2 = getResources().getDrawable(R.drawable.yuyin1);
		chattingTDrawable_2.setBounds(15, 0, chattingTDrawable_2.getIntrinsicWidth(), chattingTDrawable_2.getIntrinsicHeight());
		mChattingToAnimationDrawable.addFrame(chattingTDrawable_2, mDuration);
		
		Drawable chattingTDrawable_3 = getResources().getDrawable(R.drawable.yuyin2);
		chattingTDrawable_3.setBounds(15, 0, chattingTDrawable_3.getIntrinsicWidth(), chattingTDrawable_3.getIntrinsicHeight());
	...
	public final void startVoiceAnimation() {
		...
		case TYPE_VOICE_DOWNLOADING:
			...
			if(isFrom) {
				setBackgroundDrawable(mActivity.getResources().getDrawable(R.drawable.chat_qipao_blue));
			} else {
				setBackgroundDrawable(mActivity.getResources().getDrawable(R.drawable.chat_qipao_white));
			}
