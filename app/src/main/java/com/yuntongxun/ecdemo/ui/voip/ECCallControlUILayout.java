...
//		mDiaerpadBtn = (ImageView) findViewById(R.id.layout_call_dialnum);
        ...
        // 挂断电话按钮
        mCallRelease = (ImageView) findViewById(R.id.layout_call_release);
	...
	private OnClickListener l = new OnClickListener() {
		...
		public void onClick(View v) {
			...
			case R.id.layout_call_mute:
                ...
                mCallMute.setImageResource(mute ? R.drawable.yuyinliaotian_icon_jingyin_high : R.drawable.yuyinliaotian_icon_jingyin_normal);

                break;
			case R.id.layout_call_handfree:
				VoIPCallHelper.setHandFree();
                boolean handFree = VoIPCallHelper.getHandFree();
                mCallHandFree .setImageResource(handFree ? R.drawable.yuyinliaotian_icon_mianti_high : R.drawable.yuyinliaotian_icon_mianti_normal);
				break;
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.layout_call_release:
            	ImageView viewRelease = (ImageView) v;
...
//                break;
    ...
    public interface OnCallControlDelegate {
        ...
        void onViewRelease(ECCallControlUILayout controlPanelView , ImageView view);
//        void setDialerpadUI();
    }
}
