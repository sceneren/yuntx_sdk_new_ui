...
public class BSRPathBase {
    ...
    public BSRPathBase() {
        positionControlPoint = new ArrayList<PointF>();
        scaleControl = new ArrayList<Float>();
        rotationControl = new ArrayList<Float>();
        positionPointFirst = new PointF(0, 0);
        positionPointLast = new PointF(0, 0);
        endListeners = new ArrayList<OnAnmEndListener>();
    }
