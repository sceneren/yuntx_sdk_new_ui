...
public class CheckView extends View {
    ...
    private void init(Context context) {
        ...
        int defaultColor = ContextCompat.getColor(getContext(), R.color.zhihu_item_checkCircle_borderColor);
        mStrokePaint.setColor(defaultColor);
    ...
    private void initBackgroundPaint() {
        if (mBackgroundPaint == null) {
            ...
            int defaultColor = ContextCompat.getColor(getContext(), R.color.zhihu_item_checkCircle_backgroundColor);
